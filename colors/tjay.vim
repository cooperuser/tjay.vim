...
call s:HF('CursorLineNr', s:aqua, s:back2)

call s:HF('Boolean', s:purple)
call s:HF('Character', s:yellow)
call s:HF('Number', s:red)
call s:HF('String', s:yellow)
call s:HF('Conditional', s:purple)
...
call s:HF('Function', s:aqua)
call s:HF('Identifier', s:orange)
call s:HF('Ignore', s:fore3)
call s:HF('IncSearch', s:green, s:none)
...
call s:HF('Operator', s:purple)

call s:HF('Pmenu', s:fore, s:back2)
call s:HF('PmenuSel', s:back0, s:blue)
...
call s:HF('WildMenu', s:back0, s:blue)
...
call s:HF('LineNr', s:back4, s:back)
